      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12 text-white space-y-12">
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/modules/emergency/content" className="inline-block rounded-lg border border-[#00A3FF] bg-[#00A3FF]/10 px-6 py-3 font-medium text-[#00A3FF] transition-colors hover:bg-[#00A3FF]/20">
              OPEN MODULE →
            </Link>
            <Link href="/modules/emergency/api" className="inline-block rounded-lg border border-[#334155] bg-[#161B22] px-6 py-3 font-medium text-[#E6EDF3] transition-colors hover:bg-[#1F242C]">
              VIEW API →
            </Link>
            <Link href="/modules/emergency/demo" className="inline-block rounded-lg border border-[#334155] bg-[#161B22] px-6 py-3 font-medium text-[#E6EDF3] transition-colors hover:bg-[#1F242C]">
              RUN DEMO →
            </Link>
          </div>
        </section>
