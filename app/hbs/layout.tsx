  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <div>
              ...
              <p className="text-blue-200">Humanitarian Budget Support v1.6</p>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-3 py-1 bg-white/20 text-white text-xs font-bold rounded-full">v1.6</span>
            </div>
          </div>
      ...
      <footer className="bg-gray-800 text-gray-400 py-4 text-center text-sm">
        <p>HBS Module v1.6 — Institutional Analytics Platform — © 2026 IVYAR</p>
      </footer>
    </div>
  );
}