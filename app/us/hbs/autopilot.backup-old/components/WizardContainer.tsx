...
import { FileDown, History, GitCompare } from 'lucide-react';
...
export default function WizardContainer() {
  ...
  if (initialLoading) {
    return <LoadingState message="Loading decision scenarios..." />;
  }

  if (!scenarios || scenarios.length === 0) {
    return <ErrorState message="No scenarios available. Please contact support." />;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="min-h-[500px]">
        ...
        {loading && <LoadingState message="AI is analyzing your scenario..." />}
