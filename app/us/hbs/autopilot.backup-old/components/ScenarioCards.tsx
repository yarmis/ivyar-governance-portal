  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-heading-l mb-2">Select a Decision Scenario</h2>
        <p className="text-body-m text-text-secondary">
          Choose the type of evaluation you want to perform
        </p>
      </div>
            ...
            >
              ...
              {scenario.fields && (
                <div className="flex items-center gap-2 text-label-s text-text-secondary mt-auto">
                  <span>{scenario.fields.length} fields required</span>
                </div>
              )}
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-body-s text-text-secondary">
              Select a scenario above to begin. Our AI will guide you through the evaluation process, 
              providing explainable decisions with confidence scores and detailed reasoning. 
              All decisions are logged for institutional audit compliance.
            </p>
          </div>
        </div>
      </div>
