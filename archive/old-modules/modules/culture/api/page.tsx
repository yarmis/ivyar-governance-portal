...
export default function CultureAPIPage() {
  const endpoints = [
    { method: 'GET', path: '/api/v12/culture/metrics', description: 'Get culture & media metrics' },
    { method: 'GET', path: '/api/culture/events', description: 'List cultural events', params: ['category', 'date_range', 'region'] },
    { method: 'POST', path: '/api/culture/grant', description: 'Submit grant application', params: ['applicant', 'project', 'amount', 'timeline'] },
    { method: 'GET', path: '/api/culture/heritage', description: 'Access heritage database', params: ['type', 'location', 'status'] },
    { method: 'GET', path: '/api/culture/artists', description: 'Search artist database', params: ['name', 'medium', 'region'] },
  ];
    ...
    <div className="min-h-screen bg-[#0D1117] px-6 py-12">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
          ...
          <h1 className="mb-2 text-4xl font-bold text-[#E6EDF3]">Culture & Media API</h1>
          <p className="text-lg text-[#8B949E]">API documentation for cultural programs and heritage management</p>
        </div>
